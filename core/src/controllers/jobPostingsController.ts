import { Controller, Get, Put, Post, Route, Body, Tags, Response } from "tsoa";
import {jobPostingsService} from "../services/jobPostingsService.ts";
import {Path} from "npm:@tsoa/runtime@6.6.0";
import type {CreateJobPostParams, UpdateJobPostContextParams} from "../repositories/jobPostRepository.ts";

type UpdateJobPostContextRequest = Pick<UpdateJobPostContextParams, 'context' | 'jobFunction'>;
...
export class JobPostingsController extends Controller {
  ...
  @Put("/:id/context")
  @Response(500, "Internal Server Error")
  public async updateContext(@Path() id: string, @Body() params: UpdateJobPostContextRequest) {
